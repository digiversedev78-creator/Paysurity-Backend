// AGG-001: Order Aggregation Webhook Endpoints â€” satisfies REQ-AGG-001, REQ-POSR-005
...
export class AggregatorController {
   ...
   * DoorDash signs requests with ECDSA â€” verify header X-DoorDash-Signature.
  ...
  async handleUberEats(
    ...
    // const clientSecret = await (this.secretsService as any).get(`ubereats_client_secret_${tenantId}`);
