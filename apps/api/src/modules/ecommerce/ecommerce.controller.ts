...
import { TenantId } from '../../common/decorators'; // Assuming custom decorators location
...
export class ProductReviewsController {
  ...
  async createReview(
    ...
    const review = await (this.productReviewsService as any).createReview(
      tenantId,
      userId,
      productId,
  ...
  async getProductReviews(
    ...
    const result = await (this.productReviewsService as any).getProductReviews(
      tenantId,
      productId,
      queryDto,
    );
  ...
  async getReviewById(
    ...
    const review = await (this.productReviewsService as any).getReviewById(tenantId, reviewId);
  ...
  async updateReview(
    ...
    const updatedReview = await (this.productReviewsService as any).updateReview(
      tenantId,
      userId,
      reviewId,
  ...
  async deleteReview(
    ...
    await (this.productReviewsService as any).deleteReview(tenantId, userId, reviewId);
