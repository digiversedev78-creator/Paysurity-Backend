...
interface ReceiptResponse {
  ...
  subtotal: number;
  discounts: number;
  taxBreakdown: { category: string; amount: number }[];
  total: number;
  paymentDetails: any;
  timestamp: Date;
...
export class CheckoutController {
  ...
  @ApiResponse({ status: HttpStatus.CREATED, description: 'Checkout session started successfully.', type: CheckoutSessionResponse })
  ...
  async startCheckout(
    ...
    return this.checkoutService.startCheckout(tenantId, userId, startCheckoutDto);
  }
  ...
  @ApiResponse({ status: HttpStatus.OK, description: 'Item added successfully.', type: CheckoutSessionResponse })
  ...
  async scanItem(
    ...
    return this.checkoutService.scanItem(tenantId, userId, checkoutId, scanItemDto);
  }
  ...
  @ApiParam({ name: 'checkoutId', type: String, description: 'The ID of the checkout session' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Promotion applied successfully.', type: CheckoutSessionResponse })
  ...
  async applyPromotion(
    ...
    return this.checkoutService.applyPromotion(tenantId, userId, checkoutId, applyPromotionDto);
  }
  ...
  @ApiParam({ name: 'checkoutId', type: String, description: 'The ID of the checkout session' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Age verified successfully.', type: CheckoutSessionResponse })
  ...
  async verifyAge(
    ...
    return this.checkoutService.verifyAge(tenantId, userId, checkoutId, verifyAgeDto);
  }
  ...
  @ApiParam({ name: 'checkoutId', type: String, description: 'The ID of the checkout session' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Checkout session retrieved successfully.', type: CheckoutSessionResponse })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Checkout session not found.' })
  ...
  @ApiParam({ name: 'checkoutId', type: String, description: 'The ID of the checkout session' })
  @ApiResponse({ status: HttpStatus.OK, description: 'Payment processed successfully.', type: CheckoutSessionResponse })
  @ApiResponse({ status: HttpStatus.NOT_FOUND, description: 'Checkout session not found.' })
  ...
  async processPayment(
    ...
    return this.checkoutService.processPayment(tenantId, userId, checkoutId, processPaymentDto);
  }
  ...
  async finalizeCheckout(
    ...
    return this.checkoutService.finalizeCheckout(tenantId, userId, checkoutId);
  }
}
