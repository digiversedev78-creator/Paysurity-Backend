      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm">
            The Complete Payment & Business Platform. Powering growth for enterprise operators, corporate franchises, and large-scale retailers across the USA.
          </p>
        ...
        <div>
          ...
          <ul className="space-y-3">
            <li><Link href="/solutions/restaurants" className="text-gray-400 hover:text-white transition-colors">Restaurants</Link></li>
            <li><Link href="/solutions/retail" className="text-gray-400 hover:text-white transition-colors">Retail</Link></li>
            <li><Link href="/solutions/grocery" className="text-gray-400 hover:text-white transition-colors">Grocery</Link></li>
            <li><Link href="/features/pos" className="text-gray-400 hover:text-white transition-colors">POS System</Link></li>
            <li><Link href="/features/payments" className="text-gray-400 hover:text-white transition-colors">Payment Processing</Link></li>
          </ul>
        </div>
