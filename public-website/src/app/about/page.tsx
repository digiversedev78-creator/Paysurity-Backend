...
const teamMemberImages = [
  ...
  '/images/team/sara-khan.jpg',
  '/images/team/david-lee.jpg',
];
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              ...
              <div className="p-8 rounded-xl bg-gray-800 shadow-xl border border-gray-700 transform hover:scale-105 transition-transform duration-300 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
                ...
                <h3 className="text-xl font-semibold text-white mb-2">Enterprise Partners</h3>
                <p className="text-gray-300">Trusted by a rapidly growing network of corporate franchises, large-scale retailers, and enterprise operators.</p>
              </div>
            </div>
          </div>
        </section>
