    ...
    <div style={{ backgroundColor: COLORS.darkBg, minHeight: '100vh', fontFamily: FONT_FAMILY, color: COLORS.textLight }}>
      ...
      >
        <div style={{ maxWidth: '960px', margin: '0 auto' }}>
          ...
          >
            PaySurity is the complete payment & business platform, designed to empower enterprise operators, corporate franchises, and multi-location businesses with tools to thrive at scale. Explore how our integrated solutions streamline operations, enhance customer experience, and drive growth.
          </p>
