...
const CAROUSEL_SLIDES = [
  {
    ...
    subtitle: 'Enterprise Merchant Solutions',
    desc: 'Intuitive point-of-sale built for scale. Real-time inventory, order management and operations — all in one tap.',
...
const ROTATING_WORDS = [
  'Merchant Services', 'Enterprise Retail', 'Corporate Franchises', 'Hospitality Groups',
  'B2B Services', 'Healthcare Networks', "Logistics & Supply",
  "Automotive Groups",
];

const ROTATING_IMAGES = [
  'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?auto=format&fit=crop&w=1600&q=80', // Merchant Services
  'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?auto=format&fit=crop&w=1600&q=80', // Restaurant
  'https://images.unsplash.com/photo-1441986300917-64674bd600d8?auto=format&fit=crop&w=1600&q=80', // Retail Store
  'https://images.unsplash.com/photo-1542838132-92c53300491e?auto=format&fit=crop&w=1600&q=80', // Grocery
  'https://images.unsplash.com/photo-1567401893414-76b7b1e5a7a5?auto=format&fit=crop&w=1600&q=80', // Apparel Boutique
  'https://images.unsplash.com/photo-1560066984-138dadb4c035?auto=format&fit=crop&w=1600&q=80', // Salon & Spa
  'https://images.unsplash.com/photo-1589829085413-56de8ae18c73?auto=format&fit=crop&w=1600&q=80', // Law Firm
  'https://images.unsplash.com/photo-1538108149393-fbbd81895907?auto=format&fit=crop&w=1600&q=80', // Medical Practice
  'https://images.unsplash.com/photo-1619642751034-765dfdf7c58e?auto=format&fit=crop&w=1600&q=80', // Automotive Shop
];
    ...
    <div className="relative w-full select-none">
      ...
      >
        ...
        <Link
          ...
          className="relative z-20 block transition-all duration-500"
      ...
      <div className="md:hidden relative">
        ...
        {/* Center card */}
        <div className="px-[12%]">
          <Link href={CAROUSEL_SLIDES[getIdx(0)].link}>
            <CardFace slide={CAROUSEL_SLIDES[getIdx(0)]} isFocus={true} />
          </Link>
        </div>
    ...
    <div className={`${inter.className} bg-[#050508] text-gray-200 antialiased`}>
      ...
      <header className="relative min-h-screen flex flex-col items-center justify-center text-center px-4 md:px-8 overflow-hidden z-10 pt-20">
        ...
        <div className="absolute inset-0 z-0 bg-black">
          {ROTATING_IMAGES.map((img, idx) => (
            <img
              key={img}
              src={img}
              alt={ROTATING_WORDS[idx]}
              className={`absolute inset-0 w-full h-full object-cover transition-all duration-1000 ease-in-out ${
                idx === wordIndex ? 'opacity-50 scale-100' : 'opacity-0 scale-105'
              }`}
            />
          ))}
          <div className="absolute inset-0 bg-gradient-to-b from-[#050508]/50 via-[#050508]/30 to-[#050508] pointer-events-none" />
        </div>
        ...
        <div className="relative z-10 max-w-5xl mx-auto w-full">
          ...
          <div className="mb-8">
            <div className="inline-block px-4 py-1.5 rounded-full border border-emerald-500/30 bg-emerald-500/10 text-emerald-400 text-xs font-semibold tracking-widest mb-6">
              🇺🇸 Trusted by 10,000+ U.S. Enterprises
            </div>
            ...
            <div className="mb-14 px-4 w-full flex justify-center">
              <AiOmnibox />
            </div>
          </div>
      ...
      <section className="py-16 px-4 relative z-10">
        <div className="max-w-4xl mx-auto grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
          {[
            { ref: merchantsRef, value: merchantsCount, suffix: '+', label: 'Active Enterprises', color: 'text-blue-400' },
      ...
      <section id="testimonials" className="py-20 px-4 md:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              { name: 'Sarah L.', biz: 'VP of Operations, Titan Hospitality Group', img: 'photo-1573496359142-b8d87734a5a2', quote: 'PaySurity completely transformed our enterprise operations. The POS is super fast, online ordering boosted our volume by 30%, and payroll is a breeze.' },
              { name: 'Mark P.', biz: 'Director of Finance, Apex Retail Solutions', img: 'photo-1507003211169-0a1dd7228f2d', quote: 'Switching to PaySurity was the best decision for our locations. The integrated payments and unified reporting keep our business moving forward.' },
              { name: 'David R.', biz: 'COO, National Supply Network', img: 'photo-1472099645785-5658abf4ff4e', quote: 'The analytics dashboard is a game-changer. We track volume in real-time and make quick decisions. Plus, the 0% markup on processing is fantastic!' },
            ].map((t, i) => (
      ...
      <section id="verticals" className="py-20 px-4 md:px-8 relative z-10">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { img: 'photo-1517248135467-4c7edcad34c4', title: 'Enterprise Hospitality', desc: 'From multi-location ordering to unified kitchen display systems, PaySurity powers efficient large-scale operations.' },
              { img: 'photo-1555529669-e69e7aa0ba9a', title: 'Large-Scale Retail', desc: 'Manage massive inventory, sales across regions, and complex customer data effortlessly with unified checkout experiences.' },
              { img: 'photo-1542838132-92c53300491e', title: 'Corporate Supply & Grocery', desc: 'Handle high-volume transactions, complex logistics, B2B invoicing, and enterprise-wide inventory.' },
            ].map((v, i) => (
