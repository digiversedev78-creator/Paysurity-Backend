...
CREATE TABLE payment_intents (
  ...
  metadata              JSONB,                             -- STRICT Standard JSON REST API (pacs.008) Enriched Receipts schema ONLY
 ...
 * C) Standard JSON REST API Sync: All computed outputs MUST map precisely to the Standard JSON REST API <Chrgs> (Charges) and <Tax> blocks encoded natively in the pacs.008 disbursement payload.
 * 
