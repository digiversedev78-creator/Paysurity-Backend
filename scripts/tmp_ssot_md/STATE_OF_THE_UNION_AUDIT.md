...
## Pillar 3: ISO 20022 Readiness (November 2026 Mandate)

### Address Field Audit

| Table | Current Schema | ISO 20022 Compliant? |
|---|---|---|
...
2. Change `merchant_applications.business_address` JSONB to use ISO 20022 field names
...
| `syncMerchantIdentity()` ISO 20022 | Not in ORC spec | 🔴 **GAP** — add to MER module |
...
| **R3** | ISO 20022 address migration for `locations`, `merchant_applications`, `tenants` | 🔴 CRITICAL | 0 |
