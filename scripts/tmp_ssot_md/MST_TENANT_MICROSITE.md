...
### MST-016: CFO Billing Tiers (Foundation, Growth, Elite)

*   **ID:** MST-016
*   **Title:** CFO Billing Tiers & SaaS Monetization
*   **Description:** The Microsite system must support tiered billing plans as defined by the CFO. Each tier unlocks specific platform capabilities and has different fee structures.
*   **Functional Requirements:**
    *   **Foundation Tier:** Free (0% margin, basic template, `paysurity.com` subdomain).
    *   **Growth Tier:** $49/mo (10% margin, custom domain, loyalty integration).
    *   **Elite Tier:** $149/mo (20% margin, AI brief, multi-channel aggregation).
    *   The system shall enforce feature gating based on the tenant's active tier stored in `tenants.billing_tier`.
    *   Tier upgrades/downgrades shall trigger prorated billing adjustments in the `SubscriptionModule`.