export declare const kybVerifications: import("drizzle-orm/pg-core").PgTableWithColumns<{
    ...
    columns: {
        ...
        providerReportRef: import("drizzle-orm/pg-core").PgColumn<{
            name: "provider_report_ref";
            tableName: "kyb_verifications";
            dataType: "string";
            columnType: "PgVarchar";
            data: string;
...
export declare const RLS_MIGRATION_SQL_KYB_VERIFICATIONS = "\nALTER TABLE kyb_verifications ENABLE ROW LEVEL SECURITY;\n";
//# sourceMappingURL=kyb_verifications.d.ts.map